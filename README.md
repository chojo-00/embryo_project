...
```markdown
[모델 다운로드 (Dropbox)]([https://www.dropbox.com/s/abc1234/filename.pth?dl=1](https://www.dropbox.com/scl/fi/94z2vmzcm7yzsmqfsmcro/embryo_sam_model?rlkey=pntnkarsz8t9lkv4777nnrnaw&st=h5ofslxs&dl=0))
```
